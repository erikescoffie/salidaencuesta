...
for($i=1; $i <= 9; $i++) {    
	$resulta = $conexion->query("SELECT COUNT(p".$i.") FROM `encuestasalidares` WHERE p".$i." = 'TA'");
...
for($i=1; $i <= 9; $i++) {    
	$resulta = $conexion->query("SELECT COUNT(p".$i.") FROM `encuestasalidares` WHERE p".$i." = 'A'");
	$row = $resulta->fetch_row();
...
for($i=1; $i <= 9; $i++) {    
	$resulta = $conexion->query("SELECT COUNT(p".$i.") FROM `encuestasalidares` WHERE p".$i." = 'D'");
	$row = $resulta->fetch_row();
    // printf("La pregunta #" .$i. " total de A es %s.\n", $row[0]);
    // echo "<br>";
	$sumD +=(int)$row[0];
...
for($i=1; $i <= 9; $i++) {    
	$resulta = $conexion->query("SELECT COUNT(p".$i.") FROM `encuestasalidares` WHERE p".$i." = 'TD'");
	$row = $resulta->fetch_row();
...
$resulta = $conexion->query("SELECT COUNT(`pDiez`) FROM `encuestasalidares` WHERE pDiez = 'SI'");
...
$sumpDn = 0;
include 'conectar.php';
$resulta = $conexion->query("SELECT COUNT(`pDiez`) FROM `encuestasalidares` WHERE pDiez = 'NO'");
...
$sumpOs = 0;
include 'conectar.php';
$resulta = $conexion->query("SELECT COUNT(`pOnce`) FROM `encuestasalidares` WHERE pOnce = 'SI'");
...
$sumpOn = 0;
include 'conectar.php';
$resulta = $conexion->query("SELECT COUNT(`pOnce`) FROM `encuestasalidares` WHERE pOnce = 'NO'");
...
$sql = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Mejor sueldo y prestaciones'";
$resultado = mysqli_query($conexion, $sql);
$pDoc = $resultado->fetch_array(MYSQLI_NUM);

$sql2 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Horario de trabajo'";
$resultado2 = mysqli_query($conexion, $sql2);
$pDoc2 = $resultado2->fetch_array(MYSQLI_NUM); 

$sql3 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Ambiente laboral con compañeros'";
$resultado3 = mysqli_query($conexion, $sql3);
$pDoc3 = $resultado3->fetch_array(MYSQLI_NUM); 

$sql4 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Desacuerdo con Jefe'";
$resultado4 = mysqli_query($conexion, $sql4);
$pDoc4 = $resultado4->fetch_array(MYSQLI_NUM); 

$sql5 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Jubilación'";
$resultado5 = mysqli_query($conexion, $sql5);
$pDoc5 = $resultado5->fetch_array(MYSQLI_NUM); 

$sql6 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Falta de ascenso'";
$resultado6 = mysqli_query($conexion, $sql6);
$pDoc6 = $resultado6->fetch_array(MYSQLI_NUM); 

$sql7 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Continuar estudios'";
$resultado7 = mysqli_query($conexion, $sql7);
$pDoc7 = $resultado7->fetch_array(MYSQLI_NUM); 

$sql8 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Terminación de contrato'";
$resultado8 = mysqli_query($conexion, $sql8);
$pDoc8 = $resultado8->fetch_array(MYSQLI_NUM); 

$sql9 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Razones familiares y/o salud'";
$resultado9 = mysqli_query($conexion, $sql9);
$pDoc9 = $resultado9->fetch_array(MYSQLI_NUM); 

$sql10 = "SELECT COUNT(`pDoce`) AS 'pDoce' FROM `encuestasalidares` WHERE pDoce = 'Otro'";
